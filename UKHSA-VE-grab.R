...
ggplot(titer_drop_ratio) +
  ...
  geom_point(data=pajon_primary_drop,aes(x=weeks,y=waning_drop_ratio, color='Pajon: omicron-D614G'),color='cyan2') +
  geom_label(data=pajon_primary_drop,aes(x=1,y=1.82, label='Pajon: omicron-D614G: primary',color='Pajon: omicron-D614G'),color='cyan2',hjust=0,label.size=NA) +
  theme_bw() +
  # theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust=1)) +
